...
class ShakaComponent extends React.PureComponent{
  ...
  render(){
    ...
    return(
      <div className="shadow-lg mx-auto max-w-full" ref={this.videoContainer}>
...
ShakaComponent.propTypes = {
  licenseServer: PropTypes.string,
  manifestUrl: PropTypes.string,
  posterUrl: PropTypes.string
}

export default ShakaComponent;